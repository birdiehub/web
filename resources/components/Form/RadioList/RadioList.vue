...
<script>
import { convertSpacesToUnderscores } from "@/assets/js/helper.js";
...
export default {
  ...
  methods: {
    valueToId(value) {
      return convertSpacesToUnderscores(value.toLowerCase());
    },
  }
};
</script>
...
.radio-container {
  border-bottom: dashed var(--color-primary-soft) 0.1rem;
