<template>
    <div class="bottom-buttons">
        <TextIconButton :content="this.$translator.translate('global.actions.next')" height="2rem" width="7rem" icon="chevron_right" flex-direction="row-reverse" @click="nextPage()"/>
        <div class="pages">
        ...
        <TextIconButton :content="this.$translator.translate('global.actions.previous')" height="2rem" width="7rem" icon="chevron_left" @click="previousPage()"/>
    </div>
</template>
